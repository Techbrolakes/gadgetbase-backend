...
exports.resetPassword = exports.editProfile = exports.getUserDetails = void 0;
...
const getUserDetails = async (req, res) => {
    try {
        ...
        const profile = await user_service_1.default.getByQuery({ _id: user._id }, 'first_name last_name email address');

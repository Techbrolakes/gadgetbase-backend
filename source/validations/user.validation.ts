...
export const resetPassword = async (req: ExpressRequest, res: Response, next: NextFunction): Promise<Response | void> => {
...
export const recoverPassword = async (req: ExpressRequest, res: Response, next: NextFunction): Promise<Response | void> => {
   const schema = Joi.object()
      .keys({
         email: Joi.string().email().required(),
      })
...
export const resendVerification = async (req: ExpressRequest, res: Response, next: NextFunction): Promise<Response | void> => {
   const schema = Joi.object()
      .keys({
         email: Joi.string().email().required(),
      })
...
export const registerUser = async (req: ExpressRequest, res: Response, next: NextFunction): Promise<Response | void> => {
   const schema = Joi.object()
      .keys({
